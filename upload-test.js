...
var url = require("url");
var multipart = require("./vendor/multipart/lib/multipart");
var sys = require("sys");
var fs = require("fs");
...
function upload_file(req, res) {
    ...
    stream.onPartBegin = function(part) {
        ...
        if (!part.filename) {
            sys.log('undefined filename for part');
            flag = true;
            currentKey = part.name;
        }
        // Construct file name
    ...
    stream.onData = function(chunk) {
        ...
        if (!flag) {
            ...
            sys.log(sys.inspect(chunk));
            flag = false;
            params[currentKey] = chunk;
        }
    };
    ...
    stream.onEnd = function() {
        ...
        fileStream.addListener("drain", function() {
            ...
            upload_complete(res, params);
        });
    };
}

function upload_complete(res, params) {
    sys.debug("Request complete");
    sys.log(sys.inspect(params));
